...
//#include // Might have gotten it the wrong way around? should double check.
#include <virtiofs/virtiofs.h>
//#include <virtiofs/virtiofs_dax.h>
//#include <virtiofs/virtiofs_i.h>
    ...
    const void* data)
{
    ...
    return 0;*/
    uk_pr_crit("Hello from virtiofs vfsops!\n");
    return 0;
}
...
#define virtiofs_vget ((vfsop_vget_t)vfscore_nullop)
...
static struct vfscore_fs_type fs_virtiofs = {
        .vs_name = "virtiofs",
        .vs_init = NULL,
        .vs_op = &virtiofs_vfsops,
};

UK_FS_REGISTER(fs_virtiofs);