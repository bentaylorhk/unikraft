...
{/*
    ...
    *vpp = vp;
    ...
    return 0;*/
    uk_pr_crit("Hello from virtiofs vnops lookup!\n");
    return 0;
}
...
{/*
    ...
    return 0;*/
    uk_pr_crit("Hello from virtiofs vnops open!\n");
    return 0;
}
...
#define virtiofs_write       ((vnop_write_t)vfscore_vop_erofs)
#define virtiofs_seek        ((vnop_seek_t)vfscore_vop_nullop)
#define virtiofs_ioctl       ((vnop_ioctl_t)vfscore_vop_nullop)
#define virtiofs_create      ((vnop_create_t)vfscore_vop_erofs)
#define virtiofs_remove      ((vnop_remove_t)vfscore_vop_erofs)
#define virtiofs_rename      ((vnop_rename_t)vfscore_vop_erofs)
#define virtiofs_mkdir       ((vnop_mkdir_t)vfscore_vop_erofs)
#define virtiofs_rmdir       ((vnop_rmdir_t)vfscore_vop_erofs)
#define virtiofs_setattr     ((vnop_setattr_t)vfscore_vop_erofs)
#define virtiofs_inactive    ((vnop_inactive_t)vfscore_vop_nullop)
#define virtiofs_truncate    ((vnop_truncate_t)vfscore_vop_erofs)
#define virtiofs_link        ((vnop_link_t)vfscore_vop_erofs)
#define virtiofs_arc         ((vnop_cache_t) NULL) // Might have top move this directly into vnops.
#define virtiofs_fallocate   ((vnop_fallocate_t)vfscore_vop_erofs)
#define virtiofs_fsync       ((vnop_fsync_t)vfscore_vop_nullop)
#define virtiofs_symlink     ((vnop_symlink_t)vfscore_vop_erofs)
